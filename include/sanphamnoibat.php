<div class="btn-group" role="group" aria-label="Basic radio toggle button group">
    <a href="?quanly=sanphamnoibat" class="">
        <button class="btn nav-tabs-item active">Sản phẩm nổi bật</button> 
    </a>
    <a href="?quanly=sanphambanchay" class="nav-tabs-item-link"> 
        <button class="btn nav-tabs-item nav-tabs-item-hover">Sản phẩm bán chạy</button>
    </a>
</div>
<?php
...
?>
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
        <div class="home-product__item">
            <a href="?quanly=chitietsp&id=<?php echo $row_sanphamnoibat['sanpham_id'];?>" class="home-product__link" title="<?php echo $row_sanphamnoibat['sanpham_name'] ; ?>">
                <div class="home-product__item-img" style="background-image:url(./img/<?php echo $row_sanphamnoibat['hinh']; ?>);">
                </div>
                ...
                <form action="?quanly=giohang" method="post">
                    <fieldset>
                        <input type="hidden" name="tensanpham" value="<?php echo $row_sanphamnoibat['sanpham_name'] ?>" />
                        <input type="hidden" name="sanpham_id" value="<?php echo $row_sanphamnoibat['sanpham_id'] ?>" />
                        <input type="hidden" name="giasanpham" value="<?php echo $row_sanphamnoibat['sanpham_giakhuyenmai'] ?>" />
                        <input type="hidden" name="hinhanh" value="<?php echo $row_sanphamnoibat['hinh'] ?>" />
